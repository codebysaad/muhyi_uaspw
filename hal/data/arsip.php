        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Manajemen Arsip</h3>
                    <ul class="panel-controls">
                        ...
                        <li data-toggle="tooltip" data-placement="top" title="Refresh"><a
                                href="<?=$base_url;?>?arsip"><span class="fa fa-refresh"></span></a></li>
                    </ul>
                </div>
                <div class="panel-body table-responsive">
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
                            $n=1;
                            $query = mysqli_query($con,"SELECT * FROM arsip ORDER BY nim ASC")or die(mysqli_error($con));
                            ...
                            <tr>
                                ...
                                <td><?=$row['upload_at'];?></td>
                                <td>
                                    <a href="<?=$base_url;?>proses/skripsi.php?act=republikasi&id=<?=$row['idarsip'];?>"
